...
type TaskRecord struct {
	...
	Latitude   float64   `gorm:"column:latitude;type:float;not null;comment:签到地点（纬度）" json:"-"`
	Longitude  float64   `gorm:"column:longitude;type:float;not null;comment:签到地点（经度）" json:"-"`
